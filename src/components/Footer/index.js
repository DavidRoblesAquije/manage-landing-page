...
import { FooterCol, FooterContainer, FooterContent, FooterSocialMedia, SocialIconLink, FooterLink, FooterLinkItems, FooterLinks, FooterFormInput, FooterFormButton, FooterForm, FooterFormData, FooterReserved } from './FooterElements'

import { useForm } from 'react-hook-form';

const Footer = () => {

    //llamo a los valores de return en userForm
                    ...
                    <FooterCol className="col1">
                        ...
                        <FooterSocialMedia>
                            <SocialIconLink href="https://www.facebook.com/" target="_blank" aria-label="Facebook">
                                <img src={require('../../images/icon-facebook.svg').default} alt="logo" />
                            </SocialIconLink>
                            <SocialIconLink href="https://www.youtube.com/" target="_blank" aria-label="Youtube">
                                <img src={require('../../images/icon-youtube.svg').default} alt="logo" />
                            </SocialIconLink>
                            <SocialIconLink href="https://twitter.com/?lang=es" target="_blank" aria-label="Twitter">
                                <img src={require('../../images/icon-twitter.svg').default} alt="logo" />
                            </SocialIconLink>
                            <SocialIconLink href="/">
                                <img src={require('../../images/icon-pinterest.svg').default} alt="logo" />
                            </SocialIconLink>
                            <SocialIconLink href="https://www.instagram.com/?hl=es-la" target="_blank" aria-label="Instagram">
                                <img src={require('../../images/icon-instagram.svg').default} alt="logo" />
                            </SocialIconLink>
                        </FooterSocialMedia>
                    </FooterCol>
                    <FooterCol className="col2">
                        <FooterLinks>
                            <FooterLinkItems>
                                        ...
                                        register(
                                            {
                                                ...
                                                pattern: { value: /\S+@\S+\.\S+/i, message: 'Please insert a valid email' }
                                            }
                                        )
                                        //register({required: true, pattern: /^\S+@\S+$/i})
                                    }
                                />
                                <span className="text-small mensaje">
                                    {errors?.email?.message}
                                </span>
                            </FooterFormData>
                            <FooterFormButton type="submit">Go</FooterFormButton>
                        </FooterForm>
                    </FooterCol>
                </FooterContent>

                <FooterReserved>Copyright {new Date().getFullYear()}. All Rights Reserved</FooterReserved>
            </div>
